...
export function FavoritesPanel({ favorites, onSelectDate, onClose }: FavoritesPanelProps) {
  ...
  return (
    <Modal
      onClose={onClose}
      ariaLabel="Favorite quotes"
      panelClassName="bg-gradient-to-br from-srf-white to-srf-lotus/20 rounded-2xl p-6 max-w-3xl w-full max-h-[90vh] overflow-auto shadow-2xl"
    >
      <div className="flex items-center justify-between mb-6">
        <h3 className="font-heading text-2xl text-srf-blue flex items-center gap-2">
          <Heart className="w-6 h-6 text-gold-accent fill-current" />
